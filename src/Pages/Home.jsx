        ...
        <Row className='ms-3 me-3'>
            {
                data?.length > 0 ? data?.map((product, index) => (
                    <Col key={index} className='m-1' sm={12} md={6} lg={4} xl={2}>
                        <Card style={{ width: '100%',height:"20rem" }} className='position-relative'>
                            ...
                            <Card.Body className='position-absolute bottom-0 p-1'>
                                ...
                                <Card.Text className='d-flex justify-content-between '>
                                    <button className='btn'><i class="fa-solid  fa-cart-arrow-down fa-xl"></i></button>
                                    <button className='btn' onClick={()=>dispatch(addToWishlist(product))}><i class="fa-solid text-primary fa-heart-circle-plus fa-xl"></i></button>
                                </Card.Text>
                            </Card.Body>
